# -*- coding: utf-8 -*-
"""
Created on Sat Sep 21 16:11:38 2019
...
class sun:  
 ...
 def sunrise(self,when=None):  
  ...
  if present) 
  """  
  if when is None : when = datetime.now(tz=self.troms)  
 ...
 def __calc(self):  
  ...
  try:
      ...
      self.sunset_t   =self.solarnoon_t+hourangle*4/1440
        ...
        print('Cannot compute. Probably polar night or midnight sun.')
        self.solarnoon_t=(720-4*longitude-eqtime+timezone*60)/1440  
        self.sunrise_t  =self.solarnoon_t-hourangle*4/1440  
        self.sunset_t   =self.solarnoon_t+hourangle*4/1440
